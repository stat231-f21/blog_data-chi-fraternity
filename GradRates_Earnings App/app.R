...
#Import data
merged_grad_rates2 <- read_csv('merged_grad_rates2.csv')
earnings2 <- read_csv('earnings2.csv')
grad_rates_earnings <- read_csv('grad_rates_earnings.csv')
...
ui <- navbarPage(
    ...
    tabPanel(
        ...
        fluidPage(
            ...
            mainPanel(plotOutput(outputId = "gradrateline", width = "175%", 
                                 height = "600px"))
        )
    ),
    ...
    tabPanel(
        ...
        fluidPage(
            ...
            mainPanel(plotOutput(outputId = "earningsline", width = "175%", 
                                 height = "600px"))
        )
    ),
    ...
    tabPanel(
        ...
        fluidPage(
            ...
            mainPanel(plotOutput(outputId = "clust", width = "175%", 
                                 height = "700px"))
        )
    )
)
