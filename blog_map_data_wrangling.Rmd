...
# write to csv
write.csv(areas_of_study, "map_data/areas_of_study.csv")
write.csv(admission_enrollment_data, "map_data/admission_enrollment_data.csv")
write.csv(institution_types, "map_data/institution_types.csv")
write.csv(student_demographics, "map_data/student_demographics.csv")
write.csv(student_aid, "map_data/student_aid.csv")
write.csv(cluster_table, "map_data/cluster_table.csv")
